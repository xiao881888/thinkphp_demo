...
return array(
	'LOAD_EXT_CONFIG' => 'const,status,information,develop_mod,unitePushConfig,h5,turntable,follow_bet',
	'IMAGE_SEPARATOR' => ',',
	
	'DEFAULT_CONTROLLER'    =>  'Statistics', // 默认控制器名称
    ...
    'DOWNLOAD_UPLOAD' => array(
        ...
        'rootPath' => APP_PATH.'Runtime/Uploads/Download/', //保存根路径
    ...
    'EDITOR_UPLOAD' => array(
        ...
        'rootPath' => APP_PATH.'Runtime/Uploads/Editor/', //保存根路径
		'savePath' => '', //保存路径
		'saveName' => array('uniqid', ''), //上传文件命名规则，[0]-函数名，[1]-参数，多个参数使用数组
		'saveExt'  => '', //文件保存后缀，空则使用原后缀
		'replace'  => false, //存在同名是否覆盖
