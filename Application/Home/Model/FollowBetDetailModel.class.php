...
class FollowBetDetailModel extends Model {
    ...
    public function getOrderIdsByFbiId($fbi_id){
        $where['fbi_id'] = $fbi_id;
    ...
    public function getFollowBetDetailListByFbiId($fbi_id){
        $where['fbi_id'] = $fbi_id;
        return $this->where($where)->select();
    }

    public function getLastFollowDetailByFbiId($fbi_id){
        $condition['fbi_id'] = $fbi_id;
        return $this->where($condition)->order('fbd_id DESC')->getField('fbd_id');
    }
