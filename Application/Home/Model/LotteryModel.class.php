...
// 		$where['lottery_status'] = 1;
	...
	public function getLotteryInfo($lotteryId) {
	    ...
	    return $this   ->field('lottery_id','lottery_image, lottery_status, lottery_name, lottery_price, lottery_ahead_endtime,support_play_types')
    ...
    public function getLotteryNameById($lotteryId) {
        $condition = array('lottery_id'=>$lotteryId);

        return $this->where($condition)->getField('lottery_name');
    }
}