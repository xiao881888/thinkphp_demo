...
class OrderModel extends Model {
    ...
    public function addOrder($uid, $totalAmount, $issueId, $multiple, $userCouponId, $lotteryId, $orderSku, $first_issue_id=0, $identity='', $currentFollowTimes=0, $followBetId=0,$status='',$request_params=array(),$suite_id = 0,$order_type = 0) {
		if($status===''){
...
//     		$status = self::PRINTOUT_REFUND;//投注失败 =>出票失败且退款
    ...
    public function getOrderInfos($uid, $lottery_id, $order_type, $offset=0, $limit=10,$category = 0){
        ...
        $where['order_type'] = array('IN',array(ORDER_TYPE_OF_NORMAL,ORDER_TYPE_OF_FOLLOW,ORDER_TYPE_OF_OPTIMIZE));
