...
class CryptAesCtr extends CryptAes {  
  ...
  public static function encrypt($plaintext, $password, $nBits, $keep=0) {  
	...
	$key = CryptAes::cipher($pwBytes, CryptAes::keyExpansion($pwBytes));  
	...
	$keySchedule = CryptAes::keyExpansion($key);  
	//print_r($keySchedule);  
	...
	for ($b=0; $b<$blockCount; $b++) {  
	  ...
	  $cipherCntr = CryptAes::cipher($counterBlock, $keySchedule);  // -- encrypt counter block --  
