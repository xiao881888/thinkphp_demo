...
class VerifySsqNumber extends VerifyNumber {
    ...
    public function checkRange($betNumber) {
        ...
        $red = array('01', '02', '03', '04', '05', '06', '07', '08', '09', '10',
            ...
            '31', '32', '33');
        $blue = array('01', '02', '03', '04', '05', '06', '07', '08', '09', '10',
            '11', '12', '13', '14', '15', '16');
    ...
    private function _checkFormat($ball) {
    	if (preg_match('/^([0-3]\d,?){1,33}#([01]\d,?){0,16}$/', $ball)) {    	// 验证单式和复式
    	    return true;
    	} elseif (preg_match('/^([0-3]\d,?){1,33}@([0-3]\d,?){1,32}#([01]\d,?){0,16}$/', $ball)) {   // 验证胆拖
            return true;
        } else {
            return false;
        }
