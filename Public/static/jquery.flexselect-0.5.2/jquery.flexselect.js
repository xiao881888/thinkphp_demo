 ...
 */
(function($) {
  $.flexselect = function(select, options) {return this.init(select, options); };
  ...
  $.extend($.flexselect.prototype, {
    ...
    preloadCache: function() {
      ...
      $('#'+this.settings.inputIdTransform(this.select.attr("id"))).val('');
      this.picked = false;
    ...
    renderControls: function() {
      ...
      //如果当前选中的是空值，则不显示当前TEXT by tww 2013-04-02 
      if(this.select.children("option:selected").val()==""){
    	  selected = false;
      }
  ...
  $.fn.flexselect = function(options) {
    ...
    return new $.flexselect(this, options);
  };
})(jQuery);
